    ...
    >
      ...
      <ul className="flex flex-wrap justify-center gap-3 text-base sm:text-lg text-zinc-800 items-center">
        {skillsData.map((skils, index) => (
          <motion.li
            className={`sm:mb-4 mb-2 rounded-full px-3 sm:px-5 py-2 sm:py-3 bg-violet-500 dark:bg-white/10 dark:text-white/80 flex gap-2 items-center text-white shadow-lg shadow-violet-600/70`}
            key={index}
